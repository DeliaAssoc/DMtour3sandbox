...
function anim_p01s02_4()
{
  ...
  // Start animation after 1250ms
  setTimeout( function(){ 
    anim_p1_s2.playSegments([0, 230], true);
    // anim_p1_s2.play();
    anim_p1_s2.addEventListener( 'loopComplete', function(){
      anim_p1_s2.goToAndStop( 229, true );
    });
  }, 1250 );
};
...
function anim_p01s04_2()
{
  ...
  // Trigger animation
  // Start
  anim_p1_s4.playSegments([ 0, 166 ], true);
...
function anim_p01s06_4()
{
  ...
  setTimeout( function(){
    anim_p1_s6.goToAndStop( 175, true );
  }, 1250);
...
//SECTION 08
  ...
  //Check for "previous" click
  $( '#tip_p03s08 .prev' ).on( 'click', function(){
    ...
    // Change progression
    $( '#path_03_progress .eight' ).toggleClass('active inactive');
    $( '#path_03_progress .seven' ).toggleClass('inactive active');
  });
...
//SECTION 07
  ...
  //Check for "previous" click
  $( '#tip_p03s07 .prev' ).on( 'click', function(){
...
//SECTION 04
  ...
  //Check for "previous" click
  $( '#tip_p03s03-2 .prev' ).on( 'click', function(){

    //Deactivate animation and tooltip
    $( '#tip_p03s03-2' ).toggleClass( 'active inactive' );

    //Call animation
    anim_p03_3_1( 'fromPrev' );
  });
...
//SECTION 03
  ...
  //Check for "previous" click
  $( '#tip_p03s03-1 .prev' ).on( 'click', function(){
